                ...
                <div class="aside-menu flex-column-fluid">
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            @can(\App\Enums\User\PermissionEnum::APP_USER_VIEW)
                                <div class="menu-item">
                            ...
                            @can(\App\Enums\User\PermissionEnum::APP_DRIVER_VIEW)
                                <div class="menu-item">
                            ...
                            @can(\App\Enums\User\PermissionEnum::APP_OWNER_VIEW)
                                <div class="menu-item">
                                    <a class="menu-link @if (request()->routeIs('app.owners')) active @endif"
                                        href="{{ route('app.owners') }}">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link @if (request()->routeIs('access_requested')) active @endif"
                                        href="{{ route('access_requested') }}">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none">
                                        ...
                                        <span class="menu-title">Access Requested</span>
                                    </a>
                                </div>
                            @endcan
                            ...
                            <div class="menu-item">
                                <div class="menu-content pt-4 pb-0">
                                    <span class="menu-section text-muted text-uppercase fs-7">API Data</span>
                                </div>
                            </div>

                            <div class="menu-item">
                                <a class="menu-link @if (request()->routeIs('api.cities')) active @endif"
                                    href="{{ route('api.cities') }}">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25"
                                                viewBox="0 0 24 25" fill="none">
                            ...
                            @role(\App\Enums\User\RoleEnum::ADMIN)
                                <div class="menu-item">
                                    <a class="menu-link @if (request()->routeIs('requested_access')) active @endif"
                                        href="{{ route('requested_access') }}">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none">
                                        ...
                                        <span class="menu-title">Requested Access</span>
                                    </a>
                                </div>

                                <div data-kt-menu-trigger="click"
                                    class="menu-item  @if (request()->routeIs('export.*')) here show @endif menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        <div class="menu-item">
                                            <a class="menu-link @if (request()->routeIs('export.owners')) active @endif"
                                                href="{{ route('export.owners') }}">
